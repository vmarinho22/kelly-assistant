...
Para rodar o projeto, você deve ter o Python 3+ instalado em sua maquina! Para verificar se o Python está instalado e qual é a versão instalada, use o comando `python -V`.
...
Após a instalação do pipenv, inicie o ambiente virtual dele.
